...
class WOFOST_Assimilation(SimulationObject):
    ...
    *External dependencies:*
    ...
    def __call__(self, day, drv):
        ...
        DTGA = self._totass(DAYL, AMAX, EFF, LAI, KDIF, drv.IRRAD, DIFPP,
                            DSINBE, SINLD, COSLD)
    ...
    def _totass(self, DAYL, AMAX, EFF, LAI, KDIF, AVRAD, DIFPP, DSINBE,
               SINLD, COSLD):
        ...
        if (AMAX > 0. and LAI > 0. and DAYL > 0.):
            for i in range(3):
                ...
                PARDIR = PAR-PARDIF
                FGROS = self._assim(AMAX,EFF,LAI,KDIF,SINB,PARDIR,PARDIF)
                DTGA += FGROS*WGAUSS[i]
        DTGA *= DAYL
        
        return DTGA
    
    def _assim(self,AMAX,EFF,LAI,KDIF,SINB,PARDIR,PARDIF):
