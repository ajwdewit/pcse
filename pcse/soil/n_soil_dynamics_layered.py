    ...
    class SoilInorganicNModel():
        ...
        def calculate_NAVAIL(self, soiln_profile, KSORP, NH4, NO3, RD_m, SM, TRALY, TSCF_N):
            ...
            for il, layer in enumerate(soiln_profile):
                ...
                NH4_avail_layer = samm.calculate_available_NH4(KSORP, NH4[il], RD_m, layer.RHOD_kg_per_m3, SM[il], TRALY[il], TSCF_N, zmax, zmin)
                NO3_avail_layer = sni.calculate_available_NO3(NO3[il], RD_m, SM[il], TRALY[il], TSCF_N, zmax, zmin)     
        ...
        def calculate_N_uptake_rates(self, soiln_profile, delt, KSORP, N_demand_soil, NH4, NO3, RD_m, SM, TRALY, TSCF_N):
            ...
            for il, layer in enumerate(soiln_profile):
                ...
                RNO3UP[il] = sni.calculate_NO3_plant_uptake_rate(N_demand_soil, NO3[il], RD_m, SM[il], TRALY[il], TSCF_N, zmax, zmin)
        ...
        class SoilNNitrateModel():
            ...
            def calculate_available_NO3(self, NO3, RD, SM, TRALYIL, TSCF_N, zmax, zmin):
                layer_thickness = zmax - zmin
