...
from pcse.crop.leaf_dynamics import WOFOST72_Leaf_Dynamics
from pcse.crop.assimilation import WOFOST8_Assimilation, WOFOST7_Assimilation
...
from pcse.crop.wofost7 import Wofost72
...
full_tests = [
              ("test_phenology_wofost72*", DVS_Phenology, None),
              ("test_assimilation_wofost72*", WOFOST7_Assimilation, None),
              ("test_partitioning_wofost72*", DVS_Partitioning, None),
              ("test_leafdynamics_wofost72*", WOFOST72_Leaf_Dynamics, None),
